...
if(isset($_GET['blad_hps_all'])){
    ...
    while($blad_get_file = mysql_fetch_array($blad_query_get)){
		...
		if($blad_sql_hps_all){
            ...
            header("location:blad_data_berita.php");
		}
        $blad_delete_all_act = mysql_query("insert into kelakuan set id_user='$blad_id', tgl_tindakan='$blad_date', tindakan='Menghapus semua data berita', hapus_tindakan='ok'");
	}
...
if(isset($_GET['blad_id_lap_hps'])){
    ...
    $blad_sql_id_lap_hps = mysql_query("delete from berita where id_berita='$blad_id_lap_hps'");
     $blad_delete_act = mysql_query("insert into kelakuan set id_user='$blad_id', tgl_tindakan='$blad_date', tindakan='Menghapus berita : $blad_ambil_gambar[judul_berita]', hapus_tindakan='ok'");
...
<?php
        ...
        $blad_sql_insert = mysql_query("insert into berita set id_berita='$blad_id_berita', judul_berita='$blad_judul_berita', tgl_berita='$blad_tgl_berita',jam_berita='$blad_jam_berita',id_user='$blad_nama',isi_berita='$blad_isi_berita',foto_berita='$blad_foto_lap1_new',video='$blad_nama_file_baru',kode_komentar_berita='$blad_kode_komentar', hapus_berita='ok'");
             $blad_insert_act = mysql_query("insert into kelakuan set id_user='$blad_id', tgl_tindakan='$blad_date', tindakan='Tambah berita : $blad_judul_berita', hapus_tindakan='ok'");
...
<head>
  ...
  <title>Admin | <?php echo $_SESSION['bl_nama']; ?> | News Page</title>
    ...
    <div class="register">
        <div class="content-login">
            ...
            <div class="in-login" id="in-dua">
                <button type="button" class="tutup" onclick="location.href='blad_data_berita.php'"><span class="glyphicon glyphicon-remove"></span></button>
                </div>    
            </div>
...
<div class="wrapper">  
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="blad_data_berita.php"><span class="glyphicon glyphicon-globe"></span> <span>Data Berita 
            <span class="badge">
                <?php
  ...
  <div class="content-wrapper">
    <section class="content-header">
            <a href="blad_data_berita.php?blad_hps_all=<?php echo $blad_fetch['hapus_berita']; ?>"><button type="button" class="hapus-semua" onclick="return confirm('Apa anda yakin ingin menghapus semua data ini ? Data yang terhapus tidak dapat dikembalikan')"><span class="glyphicon glyphicon-trash"></span> Delete All</button></a>
    ...
    <section class="content">
        <table>
            ...
            <tr bgcolor="<?php echo $blad_backcol; ?>">
                ...
                <td align="center">
                    <a href="blad_detail_berita.php?blad_id_lap=<?php echo $blad_rows['id_berita']; ?>" class="detail"><span class="glyphicon glyphicon-folder-open"></span></a> &nbsp;
                    <a href="blad_data_berita.php?blad_id_lap_hps=<?php echo $blad_rows['id_berita']; ?>" class="hapus"><span class="glyphicon glyphicon-remove"></span></a> &nbsp;
                    <a href="blad_edt_berita.php?blad_id_lap_edt=<?php echo $blad_rows['id_berita']; ?>" class="edit"><span class="glyphicon glyphicon-pencil"></span></a>
                </td>
            </tr>
            <?php
                        $blad_no++;
