...
if(isset($_GET['blad_id_lap'])){
    ...
    $blad_sql_show = mysql_query("select * from lapangan join user on (lapangan.id_user=user.id_user) where id_lapangan='$blad_get_id'");
...
if(isset($_GET['blad_id_lap_hps'])){
    ...
    $blad_delete_act = mysql_query("insert into kelakuan set id_user='$blad_id', tgl_tindakan='$blad_date', tindakan='Menghapus lapangan : $blad_ambil_gambar[nama_lapangan]', hapus_tindakan='ok'");
...
<div class="detail-page">
    <button type="button" class="kembali" onclick="location.href='index.php'">X</button>
    <div class="content-detail">
        <div class="isi-detail" id="detail-satu">
            ...
            <div class="rows-detail">
                <div class="in-rows-det">
                    <img src="../davinci/lapangan/<?php echo $blad_fetching['foto_lapangan_1']; ?>" class="img-lap">
                </div>
                <div class="in-rows-det">
                    <img src="../davinci/lapangan/<?php echo $blad_fetching['foto_lapangan_2']; ?>" class="img-lap">
                </div>
                <div class="in-rows-det">
                    <img src="../davinci/lapangan/<?php echo $blad_fetching['foto_lapangan_3']; ?>" class="img-lap">
                </div>
                <div class="in-rows-det">
                    <img src="../davinci/lapangan/<?php echo $blad_fetching['foto_lapangan_4']; ?>" class="img-lap">
                </div>
            </div>
        </div>
        <div class="isi-detail" id="detail-dua">
            <div class="rows-detail-dua" id="rows-left">
                <div class="rows">
                    ...
                    <?php echo $blad_fetching['nama_lapangan']; ?></div>
                </div>
                <div class="rows">
                    <div class="col-md-1">
                    <span class="glyphicon glyphicon-road"></span></div>
                    <div class="col-md-10" id="info-lap">
                    <?php echo $blad_fetching['alamat_lapangan']; ?></div>
                </div>
                <div class="rows">
                    <div class="col-md-1">
                    <span class="glyphicon glyphicon-map-marker"></span></div>
                    <div class="col-md-10" id="info-lap">
                    <?php echo $blad_fetching['kota']; ?></div>
                </div>
                <div class="rows">
                    <div class="col-md-1">
                    <span class="glyphicon glyphicon-map-marker"></span></div>
                    <div class="col-md-10" id="info-lap">
                    <?php echo $blad_fetching['kecamatan']; ?></div>
                </div>
                <div class="rows">
                    <div class="col-md-1">
                    <span class="glyphicon glyphicon-map-marker"></span></div>
                    <div class="col-md-10" id="info-lap">
                    <?php echo $blad_fetching['kelurahan']; ?></div>
                </div>
                <div class="rows">
                    <div class="col-md-1">
                    <span class="glyphicon glyphicon-user"></span></div>
                    <div class="col-md-10" id="info-lap">
                    <?php echo $blad_fetching['nama_user']; ?></div>
                </div>
                <div class="rows">
                    <div class="col-md-1">
                    <span class="glyphicon glyphicon-tags"></span></div>
                    <div class="col-md-10" id="info-lap">
                    <?php echo"Rp ".number_format($blad_fetching['harga'],0,',','.'); ?> / Jam</div>
                </div>
                <div class="rows">
                    <div class="col-md-1">
                    <span class="glyphicon glyphicon-phone"></span></div>
                    <div class="col-md-10" id="info-lap">
                    <?php echo $blad_fetching['telp_lapangan']; ?></div>
                </div>
                <div class="rows">
                    <div class="col-md-12">
                        <a href="blad_detail_lapangan.php?blad_id_lap_hps=<?php echo $blad_fetching['id_lapangan']; ?>"><div class="btn btn-danger" id="button">Hapus</div></a>
                        <a href="blad_edt.php?blad_id_lap_edt=<?php echo $blad_fetching['id_lapangan']; ?>"><div class="btn btn-warning" id="button">Ubah Data</div></a>
                        </div>
                </div>
            </div>
            <div class="rows-detail-dua" id="rows-mid">
                <div class="col-md-12">
                        <span class="nama">Deskripsi Lapangan </span>
                        </div>
                <?php echo $blad_fetching['deskripsi']; ?>
            </div>
