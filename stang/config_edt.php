...
<head>
  ...
  <title>Superdmin - <?php echo $_SESSION['bl_nama']; ?> | <?php echo $blad_fetching['nama_lapangan']; ?></title>
            ...
            <div class="col-md-6">
                <div class="rows">
                    <div class="col-md-12" id="title-edt">
                        Ubah Data Lapangan : <?php echo $blad_fetching['nama_lapangan']; ?> <button type="button" class="tutup" onclick="location.href='config.php'">X</button>
                    </div>
                </div>
