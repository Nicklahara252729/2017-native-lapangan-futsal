    ...
    <div class="register">
        <div class="content-login">
            ...
            <div class="in-login" id="in-dua">
                <button type="button" class="tutup" onclick="location.href='low_index.php'"><span class="glyphicon glyphicon-remove"></span></button>
                </div>    
            </div>
    ...
    <section class="content">
        <table>
            ...
            <tr bgcolor="<?php echo $blad_backcol; ?>">
                ...
                <td align="center">
                    <a href="low_detail_berita.php?blad_id_lap=<?php echo $blad_rows['id_berita']; ?>" class="detail"><span class="glyphicon glyphicon-folder-open"></span></a> &nbsp;
                    <a href="low_index.php?blad_id_lap_hps=<?php echo $blad_rows['id_berita']; ?>" class="hapus"><span class="glyphicon glyphicon-remove"></span></a> &nbsp;
                    <a href="low_edit_berita.php?blad_id_lap_edt=<?php echo $blad_rows['id_berita']; ?>" class="edit"><span class="glyphicon glyphicon-pencil"></span></a>
                </td>
            </tr>
            <?php
                        $blad_no++;
