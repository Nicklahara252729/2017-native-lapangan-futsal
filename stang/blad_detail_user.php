...
<head>
  ...
  <title>Admin - <?php echo $_SESSION['bl_nama']; ?> | <?php echo $blad_fetching['nama_user']; ?></title>
...
<div class="detail-page">
    <button type="button" class="kembali" onclick="location.href='blad_admin_page.php'">X</button>
    <div class="content-user">
        ...
        <div class="row" id="rows-atas">
            ...
            <div class="col-md-6">
                <a href="blad_detail_user.php?blad_id_user=<?php echo $blad_fetching['id_user']; ?>"><button type="button" class="btn btn-danger" id="but-on">Hapus</button></a>
                <a href="blad_edt_admin.php?blad_id_lap_edt=<?php echo $blad_fetching['id_user']; ?>"><button type="button" class="btn btn-warning" id="but-on">Ubah Data</button></a>
            </div>
        </div>
    </div>
    </div>
