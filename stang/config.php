...
<?php
        ...
        $blad_sql_insert = mysql_query("insert into lapangan set id_lapangan='$blad_id_lapangan', nama_lapangan='$blad_nama_lapangan', alamat_lapangan='$blad_alamat_lapangan', kota='$blad_kota', kecamatan='$blad_kecamatan', kelurahan='$blad_kelurahan', deskripsi='$blad_deskripsi', kode_komentar='$blad_kode_komentar',id_user='$blad_id_user',harga='$blad_harga',telp_lapangan='$blad_telp_lapangan', foto_lapangan_1='$blad_foto_lap1_new', foto_lapangan_2='$blad_foto_lap2_new', foto_lapangan_3='$blad_foto_lap3_new', foto_lapangan_4='$blad_foto_lap4_new', video='$blad_nama_file_baru', hapus_lapangan='ok'");
        if($blad_sql_insert && $blad_insert_act && isset($blad_foto_lapangan1) && isset($blad_foto_lapangan2) && isset($blad_foto_lapangan3) && isset($blad_foto_lapangan4) && isset($blad_video_lapangan)){
...
<head>
  ...
  <title>Superadmin | <?php echo $_SESSION['bl_nama']; ?> | Data Lapangan</title>
    ...
    <div class="register">
        <div class="content-login">
            ...
            <div class="in-login" id="in-dua">
                <button type="button" class="tutup" onclick="location.href='config.php'"><span class="glyphicon glyphicon-remove"></span></button>
                </div>    
            </div>
...
<div class="wrapper">  
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">MENU ADMIN</li>
          <li class="active"><a href="config.php"><span class="glyphicon glyphicon-dashboard"></span> <span>Data Lapangan <span class="badge">
              <?php
  ...
  <div class="content-wrapper">
    <section class="content-header">
            <a href="config.php?blad_hps_all=<?php echo $blad_fetch['hapus_lapangan']; ?>"><button type="button" class="hapus-semua" onclick="return confirm('Apa anda yakin ingin menghapus semua data ini ? Data yang terhapus tidak dapat dikembalikan')"><span class="glyphicon glyphicon-trash"></span> Delete All</button></a>
            <button type="button" class="tambah" id="tmb_lapangan"><span class="glyphicon glyphicon-plus"></span> Tambah Data</button>
        
        <ol class="breadcrumb">
        <li><span class="glyphicon glyphicon-dashboard"></span> &nbsp; DATA LAPANGAN</li>
      </ol>
    </section>
    <section class="content">
        <table>
            ...
            <tr bgcolor="<?php echo $blad_backcol; ?>">
                ...
                <td align="center">
                    <a href="config_detail_lapangan.php?blad_id_lap=<?php echo $blad_rows['id_lapangan']; ?>" class="detail"><span class="glyphicon glyphicon-folder-open"></span></a> &nbsp;
                    <a href="config.php?blad_id_lap_hps=<?php echo $blad_rows['id_lapangan']; ?>" class="hapus"><span class="glyphicon glyphicon-remove"></span></a> &nbsp;
                    <a href="config_edt.php?blad_id_lap_edt=<?php echo $blad_rows['id_lapangan']; ?>" class="edit"><span class="glyphicon glyphicon-pencil"></span></a>
                </td>
            </tr>
            <?php
                        $blad_no++;
