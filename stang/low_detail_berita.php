...
<div class="detail-page">
    <button type="button" class="kembali" onclick="location.href='low_index.php'">X</button>
    <div class="content-detail">
        <div class="isi-detail" id="detail-satu">
            <div class="rows-detail" id="det-vid">
                <video src="../bergerak/<?php echo $blad_fetching['video']; ?>" autoplay controls class="video-lapangan"></video>
            </div>
        ...
        <div class="isi-detail" id="detail-dua">
            <div class="rows-detail-dua" id="rows-left">
                ...
                <div class="rows">
                    <div class="col-md-12">
                        <a href="blad_detail_berita.php?blad_id_lap_hps=<?php echo $blad_fetching['id_berita'];?>"><div class="btn btn-danger" id="button">Hapus</div></a>
                        <a href="blad_edt_berita.php?blad_id_lap_det=<?php echo $blad_fetching['id_berita']; ?>"><div class="btn btn-warning" id="button">Ubah Data</div></a>
                        </div>
                </div>
            </div>
