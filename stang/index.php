...
if(isset($_GET['blad_hps_all'])){
    ...
    while($blad_get_file = mysql_fetch_array($blad_query_get)){
        ...
        $blad_delete_all_act = mysql_query("insert into kelakuan set id_user='$blad_id', tgl_tindakan='$blad_date', tindakan='Menghapus semua data lapangan', hapus_tindakan='ok'");
	}
...
<?php
        ...
        $blad_sql_insert = mysql_query("insert into lapangan set id_lapangan='$blad_id_lapangan', nama_lapangan='$blad_nama_lapangan', alamat_lapangan='$blad_alamat_lapangan', kota='$blad_kota', kecamatan='$blad_kecamatan', kelurahan='$blad_kelurahan', deskripsi='$blad_deskripsi', kode_komentar='$blad_kode_komentar',id_user='$blad_id_user',harga='$blad_harga',telp_lapangan='$blad_telp_lapangan', foto_lapangan_1='$blad_foto_lap1_new', foto_lapangan_2='$blad_foto_lap2_new', foto_lapangan_3='$blad_foto_lap3_new', foto_lapangan_4='$blad_foto_lap4_new', video='$blad_nama_file_baru', hapus_lapangan='ok'");
            $blad_insert_act = mysql_query("insert into kelakuan set id_user='$blad_id', tgl_tindakan='$blad_date', tindakan='Tambah lapangan : $blad_nama_lapangan', hapus_tindakan='ok'");
...
<head>
  ...
  <title>Admin | <?php echo $_SESSION['bl_nama']; ?> | Data Lapangan</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">MENU ADMIN</li>
          <li class="active"><a href="index.php"><span class="glyphicon glyphicon-dashboard"></span> <span>Data Lapangan <span class="badge">
              <?php
