...
<head>
  ...
  <title>Superadmin- <?php echo $_SESSION['bl_nama']; ?> | <?php echo $blad_fetching['nama_lapangan']; ?></title>
...
<div class="detail-page">
    <button type="button" class="kembali" onclick="location.href='config.php'">X</button>
    <div class="content-detail">
        ...
        <div class="isi-detail" id="detail-dua">
            <div class="rows-detail-dua" id="rows-left">
                ...
                <div class="rows">
                    <div class="col-md-12">
                        <a href="config_detail_lapangan.php?blad_id_lap_hps=<?php echo $blad_fetching['id_lapangan']; ?>"><div class="btn btn-danger" id="button">Hapus</div></a>
                        <a href="config_edt.php?blad_id_lap_edt=<?php echo $blad_fetching['id_lapangan']; ?>"><div class="btn btn-warning" id="button">Ubah Data</div></a>
                        </div>
                </div>
            </div>
