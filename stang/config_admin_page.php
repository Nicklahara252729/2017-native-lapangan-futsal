...
<head>
  ...
  <title>Superadmin | <?php echo $_SESSION['bl_nama'];?> | User Page</title>
    ...
    <div class="register">
        <div class="content-login">
            ...
            <div class="in-login" id="in-dua">
                <button type="button" class="tutup" onclick="location.href='config_admin_page.php'"><span class="glyphicon glyphicon-remove"></span></button>
                </div>    
            </div>
...
<div class="wrapper">  
  ...
  <div class="content-wrapper">
    <section class="content-header">
            <a href="config_admin_page.php ?blad_hps_all=ok"><button type="button" class="hapus-semua" onclick="return confirm('Apa anda yakin ingin menghapus semua data ini ? Data yang terhapus tidak dapat dikembalikan, termasuk data anda sendiri');"><span class="glyphicon glyphicon-trash"></span> Delete All</button></a>
    ...
    <section class="content">
        <table>
            ...
            <tr bgcolor="<?php echo $blad_backcol; ?>">
                ...
                <td align="center">
                    <a href="config_detail_user.php?blad_id_lap=<?php echo $blad_rows['id_user']; ?>" class="detail"><span class="glyphicon glyphicon-folder-open"></span></a> &nbsp;
                    <a href="config_admin_page.php?blad_id_lap_hps=<?php echo $blad_rows['id_user']; ?>" class="hapus" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');"><span class="glyphicon glyphicon-remove"></span></a> &nbsp;
                    <a href="config_edt_admin.php?blad_id_lap_edt=<?php echo $blad_rows['id_user']; ?>" class="edit"><span class="glyphicon glyphicon-pencil"></span></a>
                </td>
            </tr>
            <?php
                }else{
